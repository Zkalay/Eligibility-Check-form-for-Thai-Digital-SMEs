...
export const STEPS: StepItem[] = [
  {
    id: 1,
    key: 'partA',
    label: 'Part A: Eligibility Screening',
    shortLabel: 'A. Eligibility',
    description: 'Inclusion criteria check (A1–A6)',
  },
  {
    id: 2,
    key: 'partB',
    label: 'Part B: Firm Background',
    shortLabel: 'B. Background',
    description: 'Demographics & firm profile (B1–B7)',
  },
  {
    id: 3,
    key: 'partC',
    label: 'Part C: AI Profile',
    shortLabel: 'C. AI Profile',
    description: 'Current AI adoption & factors (C1–C5)',
  },
  {
    id: 4,
    key: 'partD',
    label: 'Part D: Absorptive Capacity',
    shortLabel: 'D. ACAP Scale',
    description: 'Knowledge processes assessment (D1–D6)',
  },
  {
    id: 5,
    key: 'partE',
    label: 'Part E: Business Model Innovation',
    shortLabel: 'E. BMI Scale',
